...
double TwoDayPackage::calculateCost() { 
	...
	// call Package::calculateCost() to call base class calculateCost function from derived class' calculateCost function
	return getTwoDayFee() + (Package::calculateCost());//replace (getWeight()*getCostPerOunce()) with call to base class calculateCost()
}
